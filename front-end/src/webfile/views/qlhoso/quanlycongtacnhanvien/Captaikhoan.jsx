        ...
        if (account.Quyenhang < 1) {
            ...
            if (existingUser) {
                ...
                axios.post('http://localhost:3000/account', dataToSend)
                    .then(_res => {
                        alert(existingUser + 'cấp thành công tài khoản có user: ' + dataToSend.User);
        ...
        <div className='ctk-all'>
            {isVisibleds && (
                <div className='ctk-list-account'>
                    <div >
                        <button onClick={toggleVisibility}>Cấp Tài Khoản</button>
                    </div>
                    <div className="">
                                    ...
                                    dsacc.slice()
                                        ...
                                        .map(ac => (
                                            <tr>
                                                ...
                                                <td className="">
                                                    <button onClick={toggleVisibility} className='btn btn-info btn-sm me-2'>Chỉnh sữa</button>
                                                    <button onClick={() => deleteaccount(ac._id)} className='btn btn-warning btn-sm'>Xoa</button>
                                                </td>
                                            </tr>
                                        ))
                                }
